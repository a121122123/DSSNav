...
#include <ultralytics_ros/BBox2DArray.h>
// #include <vision_msgs/Detection3D.h>
// #include <vision_msgs/Detection3DArray.h>
#include <ultralytics_ros/Det3D.h>
#include <ultralytics_ros/Det3DArray.h>
// #include <ultralytics_ros/YoloResult.h>
#include <ultralytics_ros/MyYoloResult.h>
...
private:
  ...
  message_filters::Subscriber<ultralytics_ros::MyYoloResult> yolo_result_sub_;
...
public:
  ...
  void projectCloud(const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,
                    const ultralytics_ros::MyYoloResult::ConstPtr& yolo_result_msg, const std_msgs::Header& header,
                    // vision_msgs::Detection3DArray& detections3d_msg,
  ...
  visualization_msgs::MarkerArray createMarkerArray(//const vision_msgs::Detection3DArray& detections3d_msg,
                                                    const ultralytics_ros::Det3DArray& detections3d_msg,
                                                    const double& duration);
};
